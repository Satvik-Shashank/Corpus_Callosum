...
SAVE_SLICES = r"C:\Users\Admin\Desktop\infant_mri_project\preprocessed\22_sagittal_slices"
...
def save_sagittal_png(data, save_path, subject):
    ...
    # ✅ Step 5A: Non-Local Means Denoising (NEW)
    png = cv2.fastNlMeansDenoising(png, None, h=12, templateWindowSize=7, searchWindowSize=21)

    # ✅ Step 5B: Edge-Preserving Sharpening (NEW)
