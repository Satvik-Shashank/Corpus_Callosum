...
SAVE_SLICES = r"C:\Users\Admin\Desktop\infant_mri_project\preprocessed\20_sagittal_slices"
...
def super_resolution_enhance(img):
    ...
    # Sharpen instead of artificial enhancement
...
def save_sagittal_png(data, save_path, subject):
    ...
    # Step 5D: Super Resolution
    png = super_resolution_enhance(png)
...
if png_files:
    ...
    for ax, fname in zip(axes, png_files):
        ...
        ax.axis("off")
    plt.suptitle("ULTRA Enhanced Medical-Grade Sagittal Slices", fontsize=13)
    plt.tight_layout()
    plt.show()
else:
